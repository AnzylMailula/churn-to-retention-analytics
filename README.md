...
## Repo Structure
├── Customer Retention Decision Brief.md — full findings, recommendations, financial impact
├──Power BI and SQL Analytical Traceability.md — full Power BI + DAX + SQL methodology, step by step
├── power-bi/ — .pbix file
